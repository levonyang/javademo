...
/**
 * 当前6.X和7.X的ES差别在于
 * getTotalHits：6.X返回数量，7.X返回TotalHits
 */
public class DefaultResultMapper extends AbstractResultMapper {
    ...
    private <T> void setPersistentEntityId(T result, String id, Class<T> clazz) {
        ...
        if (clazz.isAnnotationPresent(Document.class)) {
            ...
            PersistentPropertyAccessor<T> accessor = new ConvertingPropertyAccessor<>(persistentEntity.getPropertyAccessor(result), conversionService);
